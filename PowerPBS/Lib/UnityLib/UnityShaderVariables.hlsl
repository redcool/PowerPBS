...
CBUFFER_START(UnityPerCamera)
    ...
    //x-component is the float stereo separation value, which a positive for right eye and negative for left eye. The y,z,w components are unused.
...
// There used to be float function-like texture matrices, defined as UNITY_MATRIX_TEXTUREn. These are gone now; and are just defined to identity.
