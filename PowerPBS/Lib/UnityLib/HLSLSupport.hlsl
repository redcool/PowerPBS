...
// Define "half" precision to be half on non-GLSL platforms,
...
// we specifically define half to be float16 (same as half) as all new GPUs seems to agree on float16 being minimal precision float
#define UNITY_FIXED_IS_HALF 1
#define half min16float
#define half2 min16float2
#define half3 min16float3
...
// Define min16float/min10float to be half/half on non-D3D11 platforms.
